...
SENTRY_FEATURES['auth:register'] = Bool(os.environ.get('SENTRY_ALLOW_REGISTRATION', False))
SENTRY_FEATURES['organizations:sso'] = Bool(os.environ.get('SENTRY_ALLOW_ORGANIZATIONS_SSO', False))
SENTRY_FEATURES['organizations:create'] = Bool(os.environ.get('SENTRY_ALLOW_ORGANIZATIONS_CREATE', False))
...
if email:
    SENTRY_OPTIONS['mail.backend'] = 'smtp' if not Bool(env('SENTRY_EMAIL_USE_SSL', False)) else 'django_smtp_ssl.SSLEmailBackend'
